...
return view.extend({
	render: function() {
		...
		m = new form.Map('bacnet_mo', 'Multistate Output');
		m.tabbed = false;
		s = m.section(form.TypedSection, 'mo', _('Multistate Output configuration section'));
		s.anonymous = false;
		s.addremove = true;
		s.addbtntitle = _('Add new Multistate Output Object...');
