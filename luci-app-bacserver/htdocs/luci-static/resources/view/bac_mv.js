...
return view.extend({
	render: function() {
		...
		m = new form.Map('bacnet_mv', 'Multistate Value');
		m.tabbed = false;
		s = m.section(form.TypedSection, 'mv', _('Multistate Value configuration section'));
		s.anonymous = false;
		s.addremove = true;
		s.addbtntitle = _('Add new Multistate Value Object...');
